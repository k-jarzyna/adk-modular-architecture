...
from src.presales_workflow_agent.sub_agent.workshop.ui_agent.prompt.ui_prompt import UI_PROMPT

ui_agent = Agent(
    model=GENERIC_MODEL,
    name="ui_agent",
    description="Agent performing presales analysis from a UI designer perspective",
    instruction=UI_PROMPT,
